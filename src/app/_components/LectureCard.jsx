...
const LectureCard = ({ post }) => {
  return (
    ...
    >
      {/* Image */}
      <div className="relative flex-shrink-0 w-full aspect-[4/3] overflow-hidden mb-3 sm:mb-5">
        <img
          src={post.image}
          alt={post.title}
        ...
        />
        {/* Category pill */}
        <span className="absolute top-2 left-2 sm:top-4 sm:left-4 bg-light-gold text-white text-[0.55rem] sm:text-[0.65rem] uppercase tracking-widest font-bold px-2 py-0.5 sm:px-3 sm:py-1 rounded-full">
          {post.category}
        </span>
      </div>
