...
const AboutHero = () => (
    <section className="relative overflow-hidden bg-[var(--background)] px-5 sm:px-8 pt-28 md:pt-44 lg:pt-36 pb-16 lg:pb-20">
        ...
        <div className="main-container relative z-10 text-center">
            ...
            {/* Description */}
            <p className="section-desc max-w-2xl mx-auto text-[#555] px-1 font-light" data-aos="fade-up" data-aos-delay="300">
                Premium architectural aluminium and structural glass systems engineered for the Kingdom’s elite developments.
            </p>
        </div>
